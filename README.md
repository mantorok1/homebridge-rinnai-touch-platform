...
[![npm](https://badgen.net/npm/v/homebridge-rinnai-touch-platform?icon=npm&label) ![npm](https://badgen.net/npm/dt/homebridge-rinnai-touch-platform)](https://www.npmjs.com/package/homebridge-rinnai-touch-platform) 
