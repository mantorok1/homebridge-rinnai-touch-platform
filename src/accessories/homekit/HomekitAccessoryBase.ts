import type { CharacteristicValue, Nullable, PlatformAccessory, Service } from 'homebridge'

import type { RinnaiTouchPlatform } from '../../platform.js'

import { createHash } from 'node:crypto'

export abstract class HomekitAccessoryBase {
  ...
  setAccessoryInformation(): void {
    ...
    service
      ...
      .setCharacteristic(this.platform.Characteristic.SerialNumber, createHash('sha1').update(this.platformAccessory.UUID).digest('hex'))
  }
