...
import type { HomekitAccessoryBase } from './HomekitAccessoryBase.js'

import { PLATFORM_NAME, PLUGIN_NAME } from '../../settings.js'
import { AdvanceSwitch } from './AdvanceSwitch.js'
import { Fan } from './Fan.js'
import { HeaterCooler } from './HeaterCooler.js'
import { ManualSwitch } from './ManualSwitch.js'
import { Pump } from './Pump.js'
import { Thermostat } from './Thermostat.js'
import { ZoneSwitch } from './ZoneSwitch.js'

export class HomekitAccessoryService {
  private accessories: Map<string, HomekitAccessoryBase> = new Map()
  ...
  discoverHeaterCoolers(devices: devices): void {
    ...
    if (this.platform.settings.zoneType === 'H' && devices.heat !== undefined) {
  ...
  addAccessory<TAccessory extends HomekitAccessoryBase>(
  ...
  removeAccessory(name: string, zone?: string, mode?: string): void {
    ...
    const accessory: HomekitAccessoryBase = <HomekitAccessoryBase> this.accessories.get(key)
  ...
  configure(platformAccessory: PlatformAccessory): void {
    ...
    const accessory: HomekitAccessoryBase | undefined = this.createAccessory(platformAccessory)
  ...
  createAccessory(platformAccessory: PlatformAccessory): HomekitAccessoryBase | undefined {
